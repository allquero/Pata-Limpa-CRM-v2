...
export * from "./appointmentConfirmInput";
...
export * from "./clientHistoryAvulsosItem";
export * from "./clientHistoryAvulsosItemPet";
export * from "./clientHistoryAvulsosItemService";
