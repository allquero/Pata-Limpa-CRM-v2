 ...
 */
export const GetMyTenantHeader = zod.object({
  Authorization: zod
    .string()
    .optional()
    .describe("Opaque session token — `Bearer <sid>`."),
 ...
 */
export const RegisterMyTenantHeader = zod.object({
  Authorization: zod
    .string()
    .optional()
    .describe("Opaque session token — `Bearer <sid>`."),
...
export const RegisterMyTenantBody = zod.object({
  name: zod.string(),
...
export const UpdateMessageTemplateBody = zod.object({
  name: zod.string().optional(),
  type: zod
    .enum(["confirmacao", "lembrete", "leads", "agradecimento", "pet_pronto"])
    .optional(),
